  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted">Raise a tracked ticket - we will get back to you .</p>
        {submitted && (
          <div className="mt-3 max-w-md">
            <InlineToast tone="success" message="Ticket submitted. Our team will respond you shortly." />
          </div>
        )}
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="space-y-3">
          ...
          {tickets.length === 0 ? (
            ...
            <div className="max-h-[30rem] overflow-y-auto pr-1 scrollbar-thin">
