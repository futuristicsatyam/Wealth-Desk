  ...
  return (
    <main className="container-page py-16">
      ...
      <p className="mt-4 max-w-2xl text-sm text-muted">
        Begin with a one-time 5-day trial, then move to a plan that fits your trading horizon. All paid
        plans include dashboard access, market outlooks and alert delivery.
      </p>
      ...
      <Card className="mt-8 space-y-2">
        ...
        <ul className="grid gap-1.5 text-sm text-muted sm:grid-cols-2">
          ...
          <li>&#8226; Dashboard + Telegram alert delivery</li>
