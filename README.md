...
> **Repo layout:** the Next.js application lives in [`wealth-research-desk/`](wealth-research-desk).
> All commands below are run from inside that directory.
...
- See `wealth-research-desk/docs/DEPLOYMENT.md` for the full production checklist.
...
- `wealth-research-desk/docs/ARCHITECTURE.md` — structure, design decisions, review fixes
- `wealth-research-desk/docs/API_MAP.md` — every route and what it does
- `wealth-research-desk/docs/DEPLOYMENT.md` — production deployment checklist
